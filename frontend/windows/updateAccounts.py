...
def createUpdateAccountWindow(customerInfo):
    try:
        updateAccountWindow = Toplevel()
        updateAccountWindow.grab_set()
        updateAccountWindow.title("Update customer")
        ...
        updateCustomerFrame = LabelFrame(updateAccountWindow, text="Customer Details", borderwidth=1)
